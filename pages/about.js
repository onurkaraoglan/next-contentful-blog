    ...
    <Layout>
      <div className={styles.container}>
        ...
        <p className={styles.content}>
          ...
          applications. Also, I am familiar with AngularJS and .Net MVC. I use
          version control systems and CI/CD pipelines with my projects which run
          on cloud platforms like AWS, DigitalOcean and VSTS(Azure DevOps). I
